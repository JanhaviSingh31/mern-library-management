        ...
        <div className="row">
              ...
              <div className="col-md-9">
                  ...
                  <div className="m-1 w-75">
                    ...
                    <div className="mb-3">
                      <input type="text" value={price} placeholder="write book Price" className="form-control"
                   ...
                   <div className="mb-3">
                    <button className="btn btn-primary" onClick={handleUpdate}>UPDATE Book</button>
                   </div>
                   <div className="mb-3">
